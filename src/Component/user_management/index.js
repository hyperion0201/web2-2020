        ...
        <tbody className="body">
          <tr>
            ...
            <td>
              ...
              <Button variant="danger" className="btn" onClick={handleShow2}>
                All Account
              </Button>
            </td>
          </tr>
        ...
        <Modal.Body>
          <Form>
            ...
            <Form.Group as={Row}>
              ...
              <Col sm="8">
                <Form.Control type="text" defaultValue="Tran Dan" name="fullname"/>
              </Col>
            </Form.Group>
            <Form.Group as={Row}>
              <Form.Label column sm="2" className="padding-label">
              ...
              <Col sm="8">
                <Form.Control readOnly defaultValue="321733223" name="identifyId"/>
              </Col>
            </Form.Group>
            <Form.Group as={Row}>
              <Form.Label column sm="2" className="padding-label">
              ...
              <Col sm="8">
                <Form.Control readOnly defaultValue="TranDanCute@gmail.com" name="email"/>
              </Col>
            </Form.Group>
          </Form>
        </Modal.Body>
